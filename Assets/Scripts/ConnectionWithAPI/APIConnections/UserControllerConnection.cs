...
public class UserControllerConnection : MonoBehaviour
{
    public WebClient webClient;

    public async Awaitable<IWebRequestReponse> Register(UserModel user)
    {
    ...
    public async Awaitable<IWebRequestReponse> Login(UserModel user)
    {
